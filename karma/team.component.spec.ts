...
describe('TeamComponent', () => {
  ...
  fit('FrontEnd_TeamComponent_create_Team_Component', () => {
    expect(component).toBeTruthy();
  });

  fit('FrontEnd_TeamComponent_should have edit buttons for each team', () => {
  ...
  fit('FrontEnd_TeamComponent_should have delete buttons for each team', () => {
    const team = { id: 1, name: 'Test Team', maximumBudget: 1000000 };
  ...
  fit('FrontEnd_TeamComponent_check the Maximumbudget amount to create teams', () => {
    ...
    fit('FrontEnd_TeamComponent_check MaxBudget amount in status div to create teams', () => {
...
fit('FrontEnd_TeamComponent_should display team information by ngfor', () => {
  component.teams = [
