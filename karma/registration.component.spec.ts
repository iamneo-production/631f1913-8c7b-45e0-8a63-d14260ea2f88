...
//   }));
//*************************** */
  fit('FrontEnd_RegistrationComponent_should navigate to organizer on organizer register', () => {
  ...
  fit('FrontEnd_RegistrationComponent_should navigate to admin on admin register', () => {
