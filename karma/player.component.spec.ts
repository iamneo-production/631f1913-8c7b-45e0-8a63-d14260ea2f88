...
describe('PlayerComponent', () => {
  ...
  fit('FrontEnd_PlayerComponent_create_Player_component', () => {
    expect(component).toBeTruthy();
  });

  fit('FrontEnd_PlayerComponent_should have edit buttons for each player', () => {
  ...
  fit('FrontEnd_PlayerComponent_should have delete buttons for each player', () => {
    const player = { id: 1, name: 'Test Player', age: 25, category: 'Category A', biddingPrice: 100 };
  ...
  fit('FrontEnd_PlayerComponent_check the bidding amount', () => {
  ...
  fit('FrontEnd_PlayerComponent_check bidding amount in status div', () => {
    const fixture = TestBed.createComponent(PlayerComponent);
    const app = fixture.componentInstance;
  ...
  fit('FrontEnd_PlayerComponent_should display Player information by ngfor', () => {
    component.players = [
